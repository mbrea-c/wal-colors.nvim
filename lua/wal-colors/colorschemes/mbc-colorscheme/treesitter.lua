...
M.setup = function(set_hl, get_hl, colors)
  ...
  set_hl("@keyword.function", { fg = colors.color2:darkened(0.2), bold = true })           -- For keywords used to define a fuction.
  ...
  set_hl("@punctuation.bracket", { fg = colors.yellow:desaturated(0.2):highlighted(0.2) }) -- For brackets and parens.
  ...
  set_hl("@type.qualifier", { fg = colors.color2:lightened() })
