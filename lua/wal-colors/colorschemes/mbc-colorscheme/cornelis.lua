...
M.setup = function(set_hl, get_hl, colors)
  ...
  set_hl("CornelisError", { link = "DiagnosticUnderlineError" })
  set_hl("CornelisErrorWarning", { link = "CornelisUnderlineError" })
  set_hl("CornelisWarn", { link = "DiagnosticUnderlineWarn" })
  set_hl("CornelisUnsolvedMeta", { link = "DiagnosticUnderlineWarn" })
  set_hl("CornelisUnsolvedConstraint", { link = "DiagnosticUnderlineWarn" })
  set_hl("CornelisMissingDefinition", { link = "DiagnosticUnderlineWarn" })
  set_hl("CornelisTypeChecks", { link = "DiagnosticUnderlineWarn" })
